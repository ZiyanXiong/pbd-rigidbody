classdef ConJointFix < apbd.ConJoint
	%ConJointFix Fixed joint between two rigid bodies
	% In general, it is more efficient to use a single body rather than
	% fixing two bodies together, but sometimes it is easier to set up a
	% scene by using a fixed constraint.
	%
	% Notation:
	...
	methods
		%%
		function this = ConJointFix(bodies,Es)
