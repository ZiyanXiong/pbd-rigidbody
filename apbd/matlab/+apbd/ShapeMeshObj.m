classdef ShapeMeshObj < apbd.Shape
	%%
	properties
	...
	methods
		%%
        function this = ShapeMeshObj(filename)
		...
		function I = computeInertia(this,density)
			[this.V,this.F] = apbd.ShapeMeshObj.readOBJ(this.fileName);
		...
		function cdata = narrowphaseShape(this,E1,that,E2)
			...
			if isa(that,'apbd.ShapeMeshObj')
				...
				collisions = coalMeshMesh(E1*this.E_io, this.fileName, E2*that.E_io, that.fileName);
