classdef ConCollGroundRigid2dLinear < apbd.ConColl
	...
	methods
		%%
        function this = ConCollGroundRigid2dLinear(body,Eg)
		...
		function solveTanVel(this,k,ks,hs)
			...
			if mu > 0 
				...
				% Save Jacobi updates
				this.body.dxJacobi(1:2) = this.body.dxJacobi(1:2) + scale*dqTx(3:4);
				this.body.dxJacobi(3:4) = this.body.dxJacobi(3:4) + scale*dpTx(1:2);
			end
		end
		...
		function [dlambda,dq1,dp1] = solvePosDir1(this,c,nw)
			...
			m1 = this.body.Mp;
			I1 = this.body.Mr;
			q1 = apbd.BodyRigid2d.unproj(this.body.x1);
