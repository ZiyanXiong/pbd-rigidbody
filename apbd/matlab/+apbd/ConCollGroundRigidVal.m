classdef ConCollGroundRigidVal < apbd.ConColl
	...
	methods
		%%
		function this = ConCollGroundRigidVal(body,Eg)
		...
		function solveTanVel(this,k,ks,hs)
			...
			if mu > 0 && this.dlambdaNor > 0
				...
				% Save Jacobi updates
				this.body.dxJacobi(1:4) = this.body.dxJacobi(1:4) + scale*(dqTx + dqTy);
				this.body.dxJacobi(5:7) = this.body.dxJacobi(5:7) + scale*(dpTx + dpTy);
			end
		end
